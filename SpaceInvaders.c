...
void Timer2A_Handler(void){
	...
	else if(flg == 1 && i <= 0) flg = 0;
  TIMER2_ICR_R = 0x00000001;   // acknowledge timer2A timeout
  TimerCount++;
  Semaphore = 1; // trigger
	Nokia5110_PrintBMP(0, i, SmallEnemy10PointA, 0);
  Nokia5110_PrintBMP(16, i, SmallEnemy20PointA, 0);
  Nokia5110_PrintBMP(32, i, SmallEnemy20PointA, 0);
  Nokia5110_PrintBMP(48, i, SmallEnemy30PointA, 0);
  Nokia5110_PrintBMP(64, i, SmallEnemy30PointA, 0);
	if(flg == 0) i += 5;
	else if(flg == 1) i -= 5;
  Nokia5110_DisplayBuffer();     // draw buffer
}
